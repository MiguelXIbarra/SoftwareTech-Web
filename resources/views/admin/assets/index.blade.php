...
<div class="container-fluid">
    ...
    <div class="card mb-5 shadow-lg"
        style="background: rgba(10, 10, 10, 0.8); border: 1px solid rgba(0, 212, 255, 0.3); border-radius: 20px;">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="h-100 p-3 text-center rounded shadow-sm"
                        style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1);">
                        @if($archivo->tipo == 'imagen')
                        <div class="mb-2 rounded overflow-hidden" style="height: 120px;">
                            <img src="{{ asset('storage/' . $archivo->path) }}" class="img-fluid h-100 w-100"
                                style="object-fit: cover;">
                        </div>
                        @elseif($archivo->tipo == 'video')
                        <div class="mb-2 d-flex align-items-center justify-content-center bg-black rounded"
                            style="height: 120px;">
                        ...
                        <a href="{{ asset('storage/' . $archivo->path) }}" target="_blank"
                            class="btn-glow btn-block text-center py-2 mt-2"
                            style="font-size: 0.75rem; letter-spacing: 1px;">
                            VER RECURSO <i class="fas fa-external-link-alt ml-1"></i>
                        </a>
                    </div>
                </div>
                @endforeach
